...
db = client['scrapy_database']  # Ersetze 'scrapy_database' durch deinen gewünschten Datenbanknamen
collection = db['scrapy_collection']  # Ersetze 'scrapy_collection' durch den gewünschten Kollektionen-Namen
