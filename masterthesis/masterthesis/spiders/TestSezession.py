...
collection = db['0test']
processed_collection = db['0test1']
vocabulary_collection = db['0test2']
daily_summary_collection = db['0test3']

# Neue Sammlung, um den Fortschritt zu speichern
progress_collection = db['0test4']
...
def save_daily_summary(new_article_phrases, new_comment_phrases, start_date):
    ...
    vocabulary_growth_collection = db[
        '0test5']  # Erstelle oder referenziere eine Sammlung für das Vokabelwachstum
    ...
    with client.start_session() as session:
        try:
            ...
            for article in stored_articles:
                ...
                # Lade den aktualisierten Artikel und Kommentare aus der Rohdaten-Sammlung (blauenarzisseRaws)
