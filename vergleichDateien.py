...
with open('/masterthesis/spiders/spiders/newwords.txt', 'r', encoding='utf-8') as file1, open(
        '/masterthesis/spiders/spiders/deu-news-2020_5.txt', 'r', encoding='utf-8') as file2:
